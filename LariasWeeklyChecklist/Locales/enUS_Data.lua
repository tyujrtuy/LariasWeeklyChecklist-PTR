...
local DATASET = {

    {
        ...
        items = {
            ...
            { id = "be465df9", text = "Complete Vaults of Atal'Utek: A Toxic Tour for 1/2 of a 1/6 champion item and more importantly a Season 2 delve map. DO NOT USE THE MAP YET!" },
